...
let styles = {
	...
	'waypoint-selected': new ol.style.Style({
		image: new ol.style.Icon({
			anchor: [0.5, 1],
			src: 'http://samples.thinkgeo.com/cloud/example/image/waypoint.png',
	...
	start: new ol.style.Style({
		image: new ol.style.Icon({
			anchor: [0.5, 1],
			src: 'http://samples.thinkgeo.com/cloud/example/image/start.png',
      crossOrigin:'Anonymous'
		})
	}),
		...
		image: new ol.style.Icon({
			anchor: [0.5, 1],
			src: 'http://samples.thinkgeo.com/cloud/example/image/end.png',
      crossOrigin:'Anonymous'
		})
	}),
